...
class TestRandomPlayer(TestCase):
    ...
    def test_score(self):
        ...
        h = Hand([d1, d2, d3])
        z = Hand([d1, d2, d3, d4])
        p1 = RandomPlayer("Itay", 31, h)
        p2 = RandomPlayer("Ohad", 37, z)

        self.assertTrue(RandomPlayer.score(p1), 12)
        self.assertTrue(RandomPlayer.score(p2), 18)
    ...
    def test_has_dominoes(self):
        ...
        self.assertTrue(RandomPlayer.has_dominoes(p1))
