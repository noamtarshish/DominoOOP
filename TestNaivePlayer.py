...
class TestNaivePlayer(TestCase):
    ...
    def test_score(self):
        ...
        h = Hand([d1, d2, d3])
        z = Hand([d1, d2, d3, d4])
        p1 = NaivePlayer("Itay", 31, h)
        p2 = NaivePlayer("Ohad", 37, z)

        self.assertTrue(NaivePlayer.score(p1), 12)
        self.assertTrue(NaivePlayer.score(p2), 18)
    ...
    def test_has_dominoes(self):
        ...
        self.assertTrue(NaivePlayer.has_dominoes(p1))
